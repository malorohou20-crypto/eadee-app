...
const liveFeedPool = [
  { name:'Camille B.', city:'Lyon', sector:'Conciergerie', action:'Plan généré', detail:'Business plan <span class="lf-purple">Empire Builder</span> · score viabilité <span class="lf-score">87/100</span>' },
  { name:'Théo M.', city:'Paris 11e', sector:'SaaS', action:'Pack débloqué', detail:'Pack <span class="lf-purple">Builder</span> activé · business plan en cours' },
  ...
  { name:'Yasmine O.', city:'Montpellier', sector:'Formation', action:'Pack débloqué', detail:'Pack <span class="lf-purple">Builder</span> · formation en ligne B2B' },
  ...
  { name:'Hugo B.', city:'Paris 9e', sector:'Conciergerie', action:'Pack débloqué', detail:'Pack <span class="lf-purple">Empire Builder</span> · 3 biens gérés dès lancement' },
